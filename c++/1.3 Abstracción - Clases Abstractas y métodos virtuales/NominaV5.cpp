...
class VendedorBase : public Vendedor {
  private:
    string depto;
...
{ 
  ...
  vendedores[0] = new Vendedor("René Cruz", 15000.0f);
  vendedores[2] = new VendedorBase("Rosa Ma. López", 3500.0f, "Electrónicos");
  vendedores[3] = new VendedorPorComision("José Rodríguez", 3250.0f, 10);
  vendedores[4] = new VendedorEventual("Julia Vázquez ", 2000.0f, 4);
...
// Compilar como: g++ -std=c++11 NominaV5.cpp -o NominaV5
